...
namespace tlog {
    ...
    namespace ansi {
        const std::string ESC_ = "\033";

        const std::string RESET_ = ESC_ + "[0m";
        const std::string LINE_BEGIN_ = ESC_ + "[0G";
        const std::string ERASE_TO_END_OF_LINE_ = ESC_ + "[K";

        const std::string BLACK_   = ESC_ + "[0;30m";
        const std::string RED_     = ESC_ + "[0;31m";
        const std::string GREEN_   = ESC_ + "[0;32m";
        const std::string YELLOW_  = ESC_ + "[0;33m";
        const std::string BLUE_    = ESC_ + "[0;34m";
        const std::string MAGENTA_ = ESC_ + "[0;35m";
        const std::string CYAN_    = ESC_ + "[0;36m";
        const std::string WHITE_   = ESC_ + "[0;37m";

        const std::string BOLD_BLACK_   = ESC_ + "[1;30m";
        const std::string BOLD_RED_     = ESC_ + "[1;31m";
        const std::string BOLD_GREEN_   = ESC_ + "[1;32m";
        const std::string BOLD_YELLOW_  = ESC_ + "[1;33m";
        const std::string BOLD_BLUE_    = ESC_ + "[1;34m";
        const std::string BOLD_MAGENTA_ = ESC_ + "[1;35m";
        const std::string BOLD_CYAN_    = ESC_ + "[1;36m";
        const std::string BOLD_WHITE_   = ESC_ + "[1;37m";

        const std::string HIDE_CURSOR_ = ESC_ + "[?25l";
        const std::string SHOW_CURSOR_ = ESC_ + "[?25h";
    }
    ...
    public:
        ...
        void writeLine(const std::string& scope, ESeverity severity, const std::string& line) override {
            ...
            if (mSupportsAnsiControlSequences) {
                switch (severity) {
                    case ESeverity::Success:  textOut += ansi::GREEN_;       break;
                    case ESeverity::Info:     textOut += ansi::CYAN_;        break;
                    case ESeverity::Warning:  textOut += ansi::BOLD_YELLOW_; break;
                    case ESeverity::Debug:    textOut += ansi::MAGENTA_;     break;
                    case ESeverity::Error:    textOut += ansi::BOLD_RED_;    break;
                    case ESeverity::Progress: textOut += ansi::BLUE_;        break;
                    default:                                                break;
                }
            }
            ...
            if (mSupportsAnsiControlSequences) {
                textOut += ansi::ERASE_TO_END_OF_LINE_ + ansi::RESET_;
            }
